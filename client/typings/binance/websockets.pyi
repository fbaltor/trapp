...
class BinanceSocketManager(threading.Thread):
    ...
    def start_depth_socket(self, symbol, callback, depth=..., interval=...):
    ...
    def start_miniticker_socket(self, callback, update_time=...):
    ...
    def start_symbol_mark_price_socket(self, symbol, callback, fast=...):
    ...
    def start_all_mark_price_socket(self, callback, fast=...):
