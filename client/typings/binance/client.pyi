...
class Client(object):
    ...
    AGG_BUYER_MAKES = ...
    AGG_BEST_MATCH = ...
    def __init__(self, api_key=..., api_secret=..., requests_params=..., tld=...) -> None:
    ...
    def aggregate_trade_iter(self, symbol, start_str=..., last_id=...):
    ...
    def get_historical_klines_generator(self, symbol, interval, start_str, end_str=...):
        """Get Historical Klines from Binance
